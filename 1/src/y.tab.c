...
yyreduce:
  ...
  switch (yyn)
    {
        case 6:
#line 75 "command.y" /* yacc.c:1646  */
    { vmm_write(&vmm, (yyvsp[-2].ivalue), (yyvsp[-1].cvalue)); }
#line 1260 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 77 "command.y" /* yacc.c:1646  */
    { vmm_read(&vmm, (yyvsp[-1].ivalue)); }
#line 1266 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 79 "command.y" /* yacc.c:1646  */
    { 
      recovering = false;
      yyerrok;
    }
