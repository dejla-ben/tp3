...
{
       0,     0,     3,     5,     6,     9,    11,    16,    20
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      11,     0,    -1,    12,    -1,    -1,    12,    13,    -1,     9,
      -1,     4,     7,     8,     9,    -1,     3,     7,     9,    -1,
       1,     9,    -1
};
...
static const char *const yytname[] =
{
  ...
  "$accept", "start", "commands_list", "command", 0
};
#endif
  ...
  switch (yyn)
    {
        case 6:
#line 75 "command.y"
    { vmm_write(&vmm, (yyvsp[(2) - (4)].ivalue), (yyvsp[(3) - (4)].cvalue)); }
    break;

  case 7:
#line 77 "command.y"
    { vmm_read(&vmm, (yyvsp[(2) - (3)].ivalue)); }
    break;
